...
class AboutIteration < Neo::Koan
  ...
  def test_inject_will_blow_your_mind
    ...
    #injects the result of a loop iteration as input to the next loop iteration, hence, "inject"
...
# opening as a block allows ruby to iterate a code block over the file line-by-line as it is opened
end
